...
export const MatchingCanvas: React.FC<CanvasProps> = ({
  ...
  return (
    <div
      ref={canvasRef}
      className="relative w-full flex-1 flex flex-row justify-between px-2 last:sm:px-8 cursor-none"
    ...
    >
      <div className="flex flex-col gap-2 justify-center w-1/3 ">
        {pairs.map((pair) => (
          <div
            key={`left-${pair.left}`}
            className={`bg-white p-3 rounded-l-xl shadow-md text-2xl font-bold text-center cursor-none relative overflow-hidden
              ${
      ...
      <div className="flex flex-col gap-2 justify-center w-1/3">
        {pairs.map((pair) => (
          <div
            ...
            className={`bg-white p-3 rounded-r-xl shadow-md text-2xl font-bold text-center cursor-none relative overflow-hidden
              ${
