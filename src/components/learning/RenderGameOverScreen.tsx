...
import { ChevronRight, Sparkles, Trophy, RefreshCw, LogIn } from "lucide-react";
...
const RenderGameOverScreen = ({
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-comic">
                ...
                <div className="text-center relative z-10">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-sm sm:text-base lg:text-lg py-2.5 sm:py-3 lg:py-4 px-5 sm:px-6 lg:px-8 rounded-full transition-all shadow-xl hover:brightness-110 font-bold w-full sm:w-auto"
                    >
